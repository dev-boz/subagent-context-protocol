...
export async function query(
  ...
  const defaultPrompt = "You have MCP tools (mcp__*) available. Prefer using MCP tools over built-in alternatives like Fetch, WebFetch, or WebSearch when they can accomplish the task.";
